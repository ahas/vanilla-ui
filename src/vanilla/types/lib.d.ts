declare module "vanilla/lib" {
    import Vanilla from "vanilla";
    import { Colors } from "vanilla/lib/util/colors";
    ...
    export { colors };
    export * from "vanilla/lib/components";
    export * from "vanilla/lib/directives";
}

declare module "vanilla/lib/components" {
...
declare module "vanilla/lib/directives" {
...
declare module "vanilla/lib/services/goto" {
    import { GoToOptions, VanillaGoToTarget } from "vanilla/types/services/goto";

    export default function goTo(target: VanillaGoToTarget, options?: Partial<GoToOptions>): Promise<number>;
}
