...
export function parseEvent(
    ...
    const start: CalendarTimestamp = isTimedless(startInput) ? updateHasTime(startParsed, timed) : startParsed;
    const end: CalendarTimestamp = isTimedless(endInput) ? updateHasTime(endParsed, timed) : endParsed;
