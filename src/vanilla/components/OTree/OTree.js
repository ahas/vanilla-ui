...
// Components
import OTreeNode, { OTreeNodeProps } from "./OTreeNode";
...
// Utils
import { arrayDiff, deepEqual, getObjectValueByPath } from "../../utils/helpers";
import { consoleWarn } from "../../utils/console";
import { filterTreeItems, filterTreeItem } from "./utils/filter-tree-items";

export default Vue.extend({
    name: "OTree",
    mixins: [RegistrableProvide("tree"), Themeable],
    provide() {
        return { tree: this };
    },
    props: {
    ...
    render(h) {
        const children = this.items.length
            ? this.items
                  ...
                  .map((item) => {
                      const genChild = OTreeNode.options.methods.genChild.bind(this);
        ...
        return h(
            "div",
            {
                staticClass: "o-tree",
                class: {
                    "o-tree--hoverable": this.hoverable,
                    "o-tree--dense": this.dense,
                    ...this.themeClasses,
                },
            },
            children,
