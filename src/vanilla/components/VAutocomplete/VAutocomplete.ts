...
import { getObjectValueByPath, getPropertyFromItem } from "../../utils/helpers";
...
export default VSelect.extend({
    ...
    methods: {
        ...
        changeSelectedIndex(keyCode: string) {
            // Do not allow changing of selectedIndex
            // when search is dirty
            if (this.searchIsDirty) return;

            if (this.multiple && keyCode === "ArrowLeft") {
                if (this.selectedIndex === -1) {
                    this.selectedIndex = this.selectedItems.length - 1;
                } else {
                    this.selectedIndex--;
                }
            } else if (this.multiple && keyCode === "ArrowRight") {
        ...
        onKeyDown(e: KeyboardEvent) {
            ...
            if (e.ctrlKey || !["Home", "End"].includes(keyCode)) {
