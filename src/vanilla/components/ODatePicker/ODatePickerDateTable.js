...
export default Vue.extend({
        ...
        genWeekNumber(weekNumber) {
            return this.$createElement("td", [
                this.$createElement(
                    "small",
                    {
                        staticClass: "o-date-picker-table--date__week",
                    },
    ...
    render() {
        return this.genTable("o-date-picker-table o-date-picker-table--date", [this.genTHead(), this.genTBody()], this.calculateTableDate);
    },
});
