    ...
    methods: {
        ...
        genHead() {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-daily__head",
                    style: {
        ...
        genHeadIntervals() {
            ...
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-daily__intervals-head",
                    style: {
                        width,
                    },
                },
        ...
        genHeadDay(day, index) {
            return this.$createElement(
                ...
                {
                    key: day.date,
                    staticClass: "o-calendar-daily_head-day",
        ...
        genHeadWeekday(day) {
            ...
            return this.$createElement(
                ...
                this.setTextColor(color, {
                    staticClass: "o-calendar-daily_head-weekday",
                }),
        ...
        genHeadDayLabel(day) {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-daily_head-day-label",
                },
        ...
        genBody() {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-daily__body",
                },
                [this.genScrollArea()],
            );
        },
        genScrollArea() {
            return this.$createElement(
                ...
                {
                    ref: "scrollArea",
                    staticClass: "o-calendar-daily__scroll-area",
                },
                [this.genPane()],
            );
        },
        genPane() {
            return this.$createElement(
                ...
                {
                    ref: "pane",
                    staticClass: "o-calendar-daily__pane",
                    style: {
        ...
        genDayContainer() {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-daily__day-container",
                },
        ...
        genBodyIntervals() {
            const width = convertToUnit(this.intervalWidth);
            const data = {
                staticClass: "o-calendar-daily__intervals-body",
                style: {
                    width,
                },
        ...
        genIntervalLabel(interval) {
            ...
            return this.$createElement(
                ...
                {
                    key: interval.time,
                    staticClass: "o-calendar-daily__interval",
                    style: {
                        height,
                    },
                },
                [
                    this.$createElement(
                        "div",
                        {
                            staticClass: "o-calendar-daily__interval-text",
                        },
                        label,
                    ),
                ],
