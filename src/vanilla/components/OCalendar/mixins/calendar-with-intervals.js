...
import { parseTime, copyTimestamp, updateMinutes, createDayList, createIntervalList, createNativeLocaleFormatter, MINUTES_IN_DAY } from "../utils/timestamp";
...
export default CalendarBase.extend({
    ...
    computed: {
        ...
        intervalFormatter() {
            ...
            return createNativeLocaleFormatter(this.currentLocale, (tms, short) =>
