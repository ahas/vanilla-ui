...
import { weekNumber } from "../../utils/date-time-utils";
import props from "./utils/props";
import { createDayList, getDayIdentifier, createNativeLocaleFormatter } from "./utils/timestamp";
    ...
    methods: {
        ...
        genHead() {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-weekly__head",
                },
                this.genHeadDays(),
            );
        },
            ...
            if (this.showWeek) {
                header.unshift(
                    this.$createElement("div", {
                        staticClass: "o-calendar-weekly__head-weeknumber",
                    }),
                );
            }
        ...
        genHeadDay(day, index) {
            ...
            return this.$createElement(
                ...
                this.setTextColor(color, {
                    key: day.date,
                    staticClass: "o-calendar-weekly__head-weekday",
        ...
        genWeek(week, weekNumber) {
            ...
            return this.$createElement(
                ...
                {
                    key: week[0].date,
                    staticClass: "o-calendar-weekly__week",
                },
                weekNodes,
            );
        },
        ...
        genWeekNumber(weekNumber) {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-weekly__weeknumber",
                },
        ...
        genDay(day, index, week) {
            ...
            return this.$createElement(
                ...
                {
                    key: day.date,
                    staticClass: "o-calendar-weekly__day",
                    class: this.getRelativeClasses(day, outside),
                    on: this.getDefaultMouseEventHandlers(":day", (_e) => day),
                },
                [this.genDayLabel(day), ...(getSlot(this, "day", () => ({ outside, index, week, ...day })) || [])],
            );
        },
        genDayLabel(day) {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-calendar-weekly__day-label",
                },
        ...
        genDayMonth(day) {
            ...
            return this.$createElement(
                "div",
                this.setTextColor(color, {
                    staticClass: "o-calendar-weekly__day-month",
                }),
