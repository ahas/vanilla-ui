...
// Calendars
import OCalendarMonthly from "./OCalendarMonthly";
import OCalendarDaily from "./OCalendarDaily";
import OCalendarWeekly from "./OCalendarWeekly";
import OCalendarCategory from "./OCalendarCategory";
...
export default CalendarWithEvents.extend({
    ...
    computed: {
        ...
        renderProps() {
            ...
            switch (this.type) {
                case "month":
                    component = OCalendarMonthly;
                    start = getStartOfMonth(around);
                    end = getEndOfMonth(around);
                    break;
                case "week":
                    component = OCalendarDaily;
    ...
    render(h) {
        ...
        return h(component, {
            staticClass: "o-calendar",
            class: {
                "o-calendar-events": !this.noEvents,
            },
            props: {
                ...this.$props,
                start: start.date,
