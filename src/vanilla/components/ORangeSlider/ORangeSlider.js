// Styles
import "./ORangeSlider.scss";

// Helpers
import { addOnceEventListener, createRange, deepEqual, passiveSupported } from "../../utils/helpers";
// Components
import OSlider from "../OSlider/OSlider";

/* @vue/component */
export default OSlider.extend({
    name: "ORangeSlider",
    props: {
        value: {
            type: Array,
    ...
    computed: {
        classes() {
            return {
                ...OSlider.options.computed.classes.call(this),
                "o-input--range-slider": true,
            };
        },
        internalValue: {
            get() {
    ...
    methods: {
        getTrackStyle(startLength, endLength, startPadding = 0, endPadding = 0) {
            const startDir = this.vertical ? (this.$vanilla.rtl ? "top" : "bottom") : this.$vanilla.rtl ? "right" : "left";
        ...
        genInput() {
            return createRange(2).map((i) => {
                const input = OSlider.options.methods.genInput.call(this);
        ...
        genTrackContainer() {
            ...
            const sections = [
                {
                    class: "o-slider__track-background",
                    color: this.computedTrackColor,
                    styles: [0, this.inputWidth[0], 0, -padding],
                },
                {
                    class: this.isDisabled ? "o-slider__track-background" : "o-slider__track-fill",
            ...
            if (this.$vanilla.rtl) sections.reverse();
