...
export default Vue.extend({
    ...
    render(h, { props, data }) {
        ...
        if (props.ripple && !props.disabled) {
            const ripple = h(
                ...
                Colorable.options.methods.setTextColor(props.color, {
                    staticClass: "o-input--selection-controls__ripple",
                    directives: [
                        {
                            name: "ripple",
                            value: { center: true },
        ...
        return h(
            ...
            mergeData(data, {
                class: {
                    "o-simple-checkbox": true,
                    "o-simple-checkbox--disabled": props.disabled,
                },
                on: {
                    click: (e) => {
                        e.stopPropagation();
            ...
            [h("div", { staticClass: "o-input--selection-controls__input" }, children)],
        );
    },
});
