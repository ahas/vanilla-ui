...
// Types
import { PropType, VNodeChildren } from "vue";
    ...
    methods: {
        ...
        genTable(staticClass: string, children: VNodeChildren, calculateTableDate: CalculateTableDateFunction) {
            ...
            const touchDirective = {
                name: "touch",
                value: {
                    left: (e: TouchWrapper) => e.offsetX < -15 && this.isValidScroll(1, calculateTableDate) && this.touch(1, calculateTableDate),
                    right: (e: TouchWrapper) => e.offsetX > 15 && this.isValidScroll(-1, calculateTableDate) && this.touch(-1, calculateTableDate),
                },
            };
