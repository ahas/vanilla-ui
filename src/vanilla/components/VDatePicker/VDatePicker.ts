...
import { daysInMonth } from "../VCalendar/utils/timestamp";
    ...
    computed: {
        ...
        defaultTitleMultipleDateFormatter(): DatePickerMultipleFormatter {
            return (dates) => {
                ...
                return this.$vanilla.lang.t(this.selectedItemsText, dates.length);
            };
        },
        defaultTitleDateFormatter(): DatePickerFormatter {
            ...
            } as { [key: string]: Intl.DateTimeFormatOptions };
    ...
    watch: {
        ...
        type(type: DatePickerType) {
            ...
            if (this.value && this.value.length) {
                const output = this.multipleValue.map((val: string) => sanitizeDateString(val, type)).filter(this.isDateAllowed);
        ...
        genPickerBody(): VNode {
            const children =
                this.internalActivePicker === "YEAR"
                    ? [this.genYears()]
                    : [this.genTableHeader(), this.internalActivePicker === "DATE" ? this.genDateTable() : this.genMonthTable()];
