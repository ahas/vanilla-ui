...
// Helpers
import { addOnceEventListener, deepEqual, createRange, convertToUnit, passiveSupported, KeyCodes } from "../../utils/helpers";
...
export default mixins<
    options &
        ...
        ExtractVue<[typeof VInput, typeof Loadable]>
...
>(
    ...
    methods: {
        ...
        genThumbContainer(value: number, valueWidth: number, isActive: boolean, isFocused: boolean, onFocus: Function, onBlur: Function, ref = "thumb"): VNode {
        ...
        parseKeyDown(e: KeyboardEvent, value: number) {
            ...
            if (![pageup, pagedown, end, home, left, right, down, up].includes(e.code)) {
                return;
            }
            ...
            if ([left, right, down, up].includes(e.code)) {
                const increase = this.$vanilla.rtl ? [left, up] : [right, up];
                const direction = increase.includes(e.code) ? 1 : -1;
                ...
                const direction = e.code === pagedown ? 1 : -1;
