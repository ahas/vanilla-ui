...
// Helpers
import { parseHex } from "../../utils/color-utils";

// Utils
import { fromRGBA, fromHexa, fromHSLA } from "./utils";
...
export default Vue.extend({
    ...
    methods: {
        ...
        genInput(target, attrs, value, on) {
            return this.$createElement(
                "div",
                {
                    staticClass: "o-color-picker__input",
                },
                [
        ...
        genSwitch() {
            return this.$createElement(
                ...
                [this.$createElement(OIcon, "$unfold")],
            );
        },
    },
    ...
    render(h) {
        return h(
            "div",
            {
                staticClass: "o-color-picker__edit",
            },
