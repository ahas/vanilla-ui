...
// Styles
import "./OColorPIckerCanvas.scss";

// Helpers
import { clamp, convertToUnit } from "../../utils/helpers";
import { fromHSVA, fromRGBA } from "./utils";

export default Vue.extend({
    name: "OColorPickerCanvas",
    props: {
        color: {
            type: Object,
    ...
    methods: {
        ...
        genDot() {
            ...
            return this.$createElement("div", {
                staticClass: "o-color-picker__canvas-dot",
                class: {
                    "o-color-picker__canvas-dot--disabled": this.disabled,
                },
                style: {
    ...
    render(h) {
        return h(
            "div",
            {
                staticClass: "o-color-picker__canvas",
                style: {
